    ...
    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a
                    href="{{ route('panel.chef.edit', $chef->uuid) }}">@yield('title')</a></li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">@yield('title')</h1>
            <p class="mb-0">Edit Chef {{ $chef->name }} </p>
        </div>
        <div>
            <a href="{{ route('panel.chef.index') }}" class="btn btn-outline-primary"><i
                ...
                <form action="{{ route('panel.chef.update', $chef->uuid) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $chef->name) }}">
                        @error('name')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('storage/' . $chef->photo) }}" class="img-fluid w-25 mt-2" alt="foto chef">
                                @error('photo')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror">{{ old('description', $chef->description) }}</textarea>
                        @error('description')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="text" name="instagram_link" class="form-control @error('instagram_link') is-invalid @enderror" value="{{ old('instagram_link', $chef->instagram_link) }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-4">
                                ...
                                <input type="text" name="linkedin_link" class="form-control @error('linkedin_link') is-invalid @enderror" value="{{ old('linkedin_link', $chef->linkedin_link) }}">
                                @error('linkedin_link')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
