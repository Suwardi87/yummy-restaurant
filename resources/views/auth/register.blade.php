                        ...
                        <form method="POST" action="{{ route('register') }}" class="mt-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Your Name" id="name" value="{{ old('name') }}" autofocus required>
                                    @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" name="password_confirmation" placeholder="Confirm Password" class="form-control @error('password') is-invalid @enderror" id="password_confirmation" required>
                                        @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
